...
-- ==========================================================
-- 2. Create Fact Table (Central measures)
-- ==========================================================
...
CREATE TABLE fact_sales (
    ...
    total_amount DECIMAL(15, 2), -- Calculated measure
...
-- ==========================================================
-- 3. INSERT Cleaned/Standardized Sample Data
-- ==========================================================

-- Populate dim_product (Fixing casing issues)
...
-- Populate dim_store (Handling NULL city from raw data)
...
-- Populate dim_date (Standardizing diverse formats)
...
-- Populate fact_sales (10 rows of cleaned transactional data)
